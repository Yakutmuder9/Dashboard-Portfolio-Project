    ...
    <div className="profile w-100 h-auto px-3">
      <div className="container-fluid profileTop  d-flex justify-content-between firstProfileBox">
        ...
        <div className="profright w-50 pe-3">
          <div className=" ">
            {" "}
            <div className="w-100 d-block d-md-flex justify-content-between">
              <button className="btn btn-primary py-2 w-100 ms-2 mt-2 shadow"> App</button>
              <button className="btn btn-secondary w-100 ms-2 mt-2 shadow">Message</button>
              <button className="btn btn-success py-2 w-100 ms-2 mt-2 shadow ">Setting</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid py-3">
        <div class="row">
          <div class="col-12 col-xl-4">
            <div class="card h-100">
              <div class="card-header pb-0 p-3">
                <h6 class="mb-0 text-dark pb-3">Platform Settings</h6>
              </div>
              ...
              <div class="card-header pb-0 p-3">
                <div class="row">
                  <div class="col-md-8 d-flex align-items-center">
                    <h6 class="mb-0 text-dark pb-3">Profile Information</h6>
                  </div>
              ...
              <div class="card-body p-3">
                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item border-0 ps-0 pb-0">
                    ...
                    <a
                      class="btn btn-twitter btn-simple mx-1 ps-1 pe-2 py-0"
                      href=""
                    >
                      <TwitterIcon />
                    </a>
          ...
          <div class="col-12 col-xl-4 mt-2" id="Groupfirends">
            <div class="card h-100">
              <div class="card-header pb-0 p-3">
                <h6 class="mb-0 text-dark pb-3">Conversations</h6>
              </div>
              <div class="card-body p-3">
                <ul class="list-group">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-3 col-md-6 mb-xl-0 mb-4" >
                    <div class="card h-100 card-plain border"id='addProjectripple'>
                      <div class="card-body addProBtn d-flex flex-column justify-content-center text-center">
                        <Link
                          to=""
